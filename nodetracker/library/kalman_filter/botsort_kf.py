"""
BotSort implementation of Kalman Filter
...
class BotSortKalmanFilter(object):
    ...
    def __init__(self):
        ...
        self._motion_mat = np.array(
            [[0.0000, 0.0000, 0.0000, 0.5340, 1.0434, 0.0000, 0.0000, 0.0000],
             [0.0000, 0.0000, 0.4325, 0.0000, 0.8030, 0.0000, 0.0000, 0.0000],
             [0.0000, 0.4088, 0.7611, 0.0000, 0.0000, 1.5927, 0.0000, 1.0913],
             [0.6701, 0.0000, 0.0070, 0.0395, 0.0000, 0.3240, 0.0000, 0.4407],
             [1.2693, 0.0000, 0.1371, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000],
             [0.4721, 0.0000, 0.0000, 0.1717, 0.9418, 1.6376, 0.0000, 0.0000],
             [0.0000, 0.0000, 0.2192, 0.0000, 0.0000, 0.0000, 0.1238, 0.0000],
             [0.0000, 0.1015, 0.0000, 0.0000, 0.0878, 0.2764, 0.0000, 0.0974]]
        )
...
def run_kf_test():
    ...
    state_A = np.array([0.5, 0.5, 0.1, 0.1])
    state_B = np.array([0.2, 0.1, 0.2, 0.3])
    state_C = np.array([0.8, 0.9, 0.05, 0.05])
    time_len = 20
    dt = 1.0
    noise_std = 1e-3
